              ...
              <div className="mt-3 flex items-center justify-between">
                ...
                {selectedCareers.length > 0 && (
                  <button
                    ...
                    className={`btn-primary flex items-center ${saved ? 'bg-green-600 hover:bg-green-600' : ''
          ...
          <div className="grid md:grid-cols-2 gap-6">
            {recommendations.career_paths?.map((career, idx) => {
              ...
              return (
                <div
                  key={idx}
                  className={`card-3d group transition-all relative ${isSelected ? 'ring-4 ring-prism-violet dark:ring-prism-cyan bg-prism-violet/10 dark:bg-prism-cyan/10' : ''
                    }`}
                >
                  ...
                  <div className="absolute top-4 right-4 flex space-x-2 z-10">
                    <button
                      ...
                      className={`w-8 h-8 rounded-full border-2 flex items-center justify-center transition-all shadow-prism ${isSelected
